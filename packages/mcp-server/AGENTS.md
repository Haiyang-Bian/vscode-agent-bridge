...
- Use authenticated loopback HTTP only. CLI diagnostics must omit credentials and management endpoints. Do not restore STDIO or tie daemon lifetime to a client's stdin.
